              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Near Mali Stop ,Shirgaon<br />
                    Shirgaon - Satpati Rd<br />
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">(+91) 9923967306</p>
                  <p className="text-muted-foreground">(+91) 9834455918</p>
                </div>

                <div>
                  <h4 className="font-semibold text-foreground mb-1">Email</h4>
                  <p className="text-muted-foreground">yashmali888@gmail.com</p>
                </div>
                ...
                <div>
                  ...
                  <div className="text-muted-foreground space-y-1">
                    <div className="flex justify-between">
                      ...
                      <span>11.00 AM - Till Late Night</span>
                    </div>
                    <div className="flex justify-between">
                ...
                <div className="bg-gradient-primary rounded-lg p-4">
                  <h4 className="font-semibold text-black mb-2">Payment Options</h4>
